...
public class JsonUtilTool {
	...
	private static String[] dateFormats =new String[] { "yyyy-MM-dd HH:mm:ss","yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss"};  
	...
	// 将JSON转换成POJO,其中beanClz为POJO的Class
		public static Object json2Object(String json, Class beanClz,Map<String, Class> m) {
			//JSONUtils.getMorpherRegistry().registerMorpher(new DateMorpherEx(dateFormats, (Date) null)); 
	...
	// 将JSON转换成String
		public static String json2String(Object json) {
			JSONObject jsonObject = JSONObject.fromObject(json);
			return jsonObject.toString();
		}
	...
	public static HashMap toHashMap(Object object) {
		...
		JSONObject jsonObject = JsonUtilTool.toJSONObject(object);
	...
	public static <T, D> T toBean(String jsonString, Class<T> mainClass,
		...
		T mainEntity = JsonUtilTool.toBean(jsonObject, mainClass);
		List<D> detailList = JsonUtilTool.toList(jsonArray, detailClass);
	...
	public static <T, D1, D2> T toBean(String jsonString, Class<T> mainClass,
		...
		T mainEntity = JsonUtilTool.toBean(jsonObject, mainClass);
		List<D1> detailList1 = JsonUtilTool.toList(jsonArray1, detailClass1);
		List<D2> detailList2 = JsonUtilTool.toList(jsonArray2, detailClass2);
	...
	public static <T, D1, D2, D3> T toBean(String jsonString,
		...
		List<D1> detailList1 = JsonUtilTool.toList(jsonArray1, detailClass1);
		List<D2> detailList2 = JsonUtilTool.toList(jsonArray2, detailClass2);
		List<D3> detailList3 = JsonUtilTool.toList(jsonArray3, detailClass3);
