...
$(function(){
   	...
   	$("#searchButton").click(function(){
   		...
   		var scoreSexValue = $("#subjectId").val();
   	   	var score= new Object();
	   	score.examName=scoreNoValue;
	   	score.classId=scoreNameValue;
	   	score.subjectId=scoreSexValue;
								...
								<table style="width: 100%;">
									<tbody>
										<tr>
											...
											<a href="<%=request.getContextPath() %>/scoreController/studentall.do" style="color:#FFF;text-decoration:none;" class="btn btn-info fa fa-refresh" title="刷新列表"></a>
